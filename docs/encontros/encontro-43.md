# Encontro 43 - Cabecalhos, rodapes e secoes reutilizaveis

**Unidade:** Unidade 2  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Layout base reutilizavel

## Explicacao geral do encontro
Este encontro trabalha **Cabecalhos, rodapes e secoes reutilizaveis** na camada visual, conectando CSS moderno com layout real, componentes e consistencia de interface.

![Imagem de apoio 1](https://upload.wikimedia.org/wikipedia/commons/d/d5/CSS3_logo_and_wordmark.svg)

## Conceitos essenciais
- Estruturas base reutilizaveis
- Layout compartilhado entre paginas
- Consistencia entre secoes de um site

## Explicacao detalhada dos conceitos essenciais
### 1) Estruturas base reutilizaveis
Estruturas base reutilizaveis orienta a tomada de decisao tecnica e melhora a qualidade do projeto.
...
### 2) Layout compartilhado entre paginas
Layout compartilhado entre paginas ajuda a transformar criterio visual e estrutural em implementacao reproduzivel.
...
### 3) Consistencia entre secoes de um site
Consistencia entre secoes de um site conecta a aula a cenarios reais de desenvolvimento e manutencao.
...
## Resumo final
Neste encontro, voce estudou **Cabecalhos, rodapes e secoes reutilizaveis** com foco em composicao visual, responsividade e escalabilidade de estilos.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Cabecalhos, rodapes e secoes reutilizaveis" ajuda a resolver?
