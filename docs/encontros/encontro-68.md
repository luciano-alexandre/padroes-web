# Encontro 68 - Projeto integrador: implementacao com framework escolhido

**Unidade:** Unidade 3  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Primeira versao

## Explicacao geral do encontro
Este encontro trabalha **Projeto integrador: implementacao com framework escolhido** na aplicacao de frameworks HTML/CSS e no desenvolvimento orientado a projeto integrador.

![Imagem de apoio 1](https://upload.wikimedia.org/wikipedia/commons/8/8e/OOjs_UI_icon_code.svg)

## Conceitos essenciais
- Aplicacao pratica da stack definida
- Montagem das principais secoes
- Coerencia entre framework e identidade

## Explicacao detalhada dos conceitos essenciais
### 1) Aplicacao pratica da stack definida
Aplicacao pratica da stack definida orienta a tomada de decisao tecnica e melhora a qualidade do projeto.
...
### 2) Montagem das principais secoes
Montagem das principais secoes ajuda a transformar criterio visual e estrutural em implementacao reproduzivel.
...
### 3) Coerencia entre framework e identidade
Coerencia entre framework e identidade conecta a aula a cenarios reais de desenvolvimento e manutencao.
...
## Resumo final
Neste encontro, voce estudou **Projeto integrador: implementacao com framework escolhido** com foco em escolha tecnologica, customizacao consciente e entrega profissional.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Projeto integrador: implementacao com framework escolhido" ajuda a resolver?
