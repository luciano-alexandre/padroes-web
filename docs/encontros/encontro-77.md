# Encontro 77 - Ensaios de apresentacao tecnica

**Unidade:** Unidade 3  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Apresentacao ensaiada

## Explicacao geral do encontro
Este encontro trabalha **Ensaios de apresentacao tecnica** na aplicacao de frameworks HTML/CSS e no desenvolvimento orientado a projeto integrador.

![Imagem de apoio 1](https://upload.wikimedia.org/wikipedia/commons/8/8e/OOjs_UI_icon_code.svg)

## Conceitos essenciais
- Narrativa tecnica de apresentacao
- Clareza na defesa das escolhas
- Preparacao para banca avaliativa

## Explicacao detalhada dos conceitos essenciais
### 1) Narrativa tecnica de apresentacao
Narrativa tecnica de apresentacao orienta a tomada de decisao tecnica e melhora a qualidade do projeto.
...
### 2) Clareza na defesa das escolhas
Clareza na defesa das escolhas ajuda a transformar criterio visual e estrutural em implementacao reproduzivel.
...
### 3) Preparacao para banca avaliativa
Preparacao para banca avaliativa conecta a aula a cenarios reais de desenvolvimento e manutencao.
...
## Resumo final
Neste encontro, voce estudou **Ensaios de apresentacao tecnica** com foco em escolha tecnologica, customizacao consciente e entrega profissional.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Ensaios de apresentacao tecnica" ajuda a resolver?
