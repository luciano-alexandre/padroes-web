...
**Unidade:** Unidade 3  
**Carga prevista:** 1,5h  
**Entregável previsto:** Mini projeto apresentado + proposta final

## Explicação do conteúdo
Apresentação do mini projeto e definição de escopo do projeto final com prioridades realistas.
...
## Resumo final
Neste encontro, voce estudou **Apresentação do mini projeto e definição do escopo final** dentro da introducao a JavaScript e DOM. O foco foi transformar paginas estaticas em interfaces interativas por meio de logica, eventos e manipulacao de elementos.

## Questoes de fixacao (com gabarito)
1. Qual papel do JavaScript no contexto do tema "Apresentação do mini projeto e definição do escopo final"?
