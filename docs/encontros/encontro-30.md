# Encontro 30 - Apresentação do mini projeto e definição do escopo final

**Unidade:** Unidade 3  
**Carga prevista:** 1,5h  
**Entregável:** Mini projeto apresentado + proposta final

## Visão Didática da Aula
Neste encontro, o foco é "Apresentação do mini projeto e definição do escopo final". A proposta é trabalhar o conteúdo em linguagem introdutória, conectando conceito, demonstração e prática orientada. O objetivo é que o estudante compreenda não apenas o que fazer, mas por que a técnica é útil em projetos reais.

![Imagem de apoio do encontro](https://upload.wikimedia.org/wikipedia/commons/9/99/Unofficial_JavaScript_logo_2.svg)

## Objetivos de Aprendizagem
- Compreender os conceitos centrais de "Apresentação do mini projeto e definição do escopo final".
- Aplicar o conteúdo em uma prática curta com feedback.
- Produzir o entregável previsto: **Mini projeto apresentado + proposta final**.
