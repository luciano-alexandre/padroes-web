...
**Unidade:** Unidade 1  
**Carga prevista:** 1,5h  
**Entregável previsto:** Ambiente configurado

## Explicação do conteúdo
Aqui o foco é preparar seu ambiente para estudar com autonomia, usando editor de código, navegador e DevTools com um fluxo simples de teste contínuo.

![Imagem de apoio ao tema](https://upload.wikimedia.org/wikipedia/commons/6/61/HTML5_logo_and_wordmark.svg)

## Conceitos essenciais
- Configuração de editor e extensões úteis.
- Uso básico de DevTools (Elements e Console).
- Fluxo de salvar, atualizar e testar.
...
console.log("Abra o DevTools para visualizar esta mensagem.");
```
...
## Resumo final
Neste encontro, voce estudou **Ambiente de desenvolvimento (editor, navegador, DevTools)** dentro dos fundamentos de HTML e estrutura da Web. O objetivo principal foi construir base conceitual e pratica para leitura, escrita e organizacao de paginas com clareza.

## Questoes de fixacao (com gabarito)
1. Qual e a ideia central do tema "Ambiente de desenvolvimento (editor, navegador, DevTools)" nesta unidade?
