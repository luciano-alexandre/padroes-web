...
**Unidade:** Unidade 2  
**Carga prevista:** 1,5h  
**Entregável:** Mini projeto apresentado

## Visão Didática da Aula
Neste encontro, o foco é "Apresentação curta do mini projeto (dia reservado)". A proposta é trabalhar o conteúdo em linguagem introdutória, conectando conceito, demonstração e prática orientada. O objetivo é que o estudante compreenda não apenas o que fazer, mas por que a técnica é útil em projetos reais.

![Imagem de apoio do encontro](https://upload.wikimedia.org/wikipedia/commons/d/d5/CSS3_logo_and_wordmark.svg)

## Objetivos de Aprendizagem
- Compreender os conceitos centrais de "Apresentação curta do mini projeto (dia reservado)".
- Aplicar o conteúdo em uma prática curta com feedback.
- Produzir o entregável previsto: **Mini projeto apresentado**.
