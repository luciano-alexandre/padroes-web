# Encontro 70 - Projeto integrador: paginas internas e navegacao

**Unidade:** Unidade 3  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Fluxo completo

## Explicacao geral do encontro
Este encontro trabalha **Projeto integrador: paginas internas e navegacao** na aplicacao de frameworks HTML/CSS e no desenvolvimento orientado a projeto integrador.

![Imagem de apoio 1](https://upload.wikimedia.org/wikipedia/commons/8/8e/OOjs_UI_icon_code.svg)

## Conceitos essenciais
- Expansao do projeto para multiplas paginas
- Fluxo coerente entre secoes
- Navegacao e continuidade visual

## Explicacao detalhada dos conceitos essenciais
### 1) Expansao do projeto para multiplas paginas
Expansao do projeto para multiplas paginas orienta a tomada de decisao tecnica e melhora a qualidade do projeto.
...
### 2) Fluxo coerente entre secoes
Fluxo coerente entre secoes ajuda a transformar criterio visual e estrutural em implementacao reproduzivel.
...
### 3) Navegacao e continuidade visual
Navegacao e continuidade visual conecta a aula a cenarios reais de desenvolvimento e manutencao.
...
## Resumo final
Neste encontro, voce estudou **Projeto integrador: paginas internas e navegacao** com foco em escolha tecnologica, customizacao consciente e entrega profissional.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Projeto integrador: paginas internas e navegacao" ajuda a resolver?
