# Encontro 67 - Projeto integrador: estrutura base em HTML semantico

**Unidade:** Unidade 3  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Estrutura pronta

## Explicacao geral do encontro
Este encontro trabalha **Projeto integrador: estrutura base em HTML semantico** na aplicacao de frameworks HTML/CSS e no desenvolvimento orientado a projeto integrador.

![Imagem de apoio 1](https://upload.wikimedia.org/wikipedia/commons/8/8e/OOjs_UI_icon_code.svg)

## Conceitos essenciais
- Estrutura inicial do projeto
- Semantica e organizacao de arquivos
- Base limpa para framework

## Explicacao detalhada dos conceitos essenciais
### 1) Estrutura inicial do projeto
Estrutura inicial do projeto orienta a tomada de decisao tecnica e melhora a qualidade do projeto.
...
### 2) Semantica e organizacao de arquivos
Semantica e organizacao de arquivos ajuda a transformar criterio visual e estrutural em implementacao reproduzivel.
...
### 3) Base limpa para framework
Base limpa para framework conecta a aula a cenarios reais de desenvolvimento e manutencao.
...
## Resumo final
Neste encontro, voce estudou **Projeto integrador: estrutura base em HTML semantico** com foco em escolha tecnologica, customizacao consciente e entrega profissional.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Projeto integrador: estrutura base em HTML semantico" ajuda a resolver?
