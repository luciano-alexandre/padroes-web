...
**Unidade:** Unidade 3  
**Carga prevista:** 1,5h  
**Entregável previsto:** Biblioteca simples de funções

## Explicação do conteúdo
Você vai organizar melhor seu código com funções, parâmetros e retorno.
...
## Resumo final
Neste encontro, voce estudou **Funções e organização de código** dentro da introducao a JavaScript e DOM. O foco foi transformar paginas estaticas em interfaces interativas por meio de logica, eventos e manipulacao de elementos.

## Questoes de fixacao (com gabarito)
1. Qual papel do JavaScript no contexto do tema "Funções e organização de código"?
