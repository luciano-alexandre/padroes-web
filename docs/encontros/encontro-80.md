# Encontro 80 - Fechamento da disciplina, autoavaliacao e consolidacao de portfolio

**Unidade:** Unidade 3  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Portfolio finalizado

## Explicacao geral do encontro
Este encontro trabalha **Fechamento da disciplina, autoavaliacao e consolidacao de portfolio** na aplicacao de frameworks HTML/CSS e no desenvolvimento orientado a projeto integrador.

![Imagem de apoio 1](https://upload.wikimedia.org/wikipedia/commons/8/8e/OOjs_UI_icon_code.svg)

## Conceitos essenciais
- Sintese do aprendizado da disciplina
- Consolidacao do portfolio academico
- Planejamento de continuidade na formacao

## Explicacao detalhada dos conceitos essenciais
### 1) Sintese do aprendizado da disciplina
Sintese do aprendizado da disciplina orienta a tomada de decisao tecnica e melhora a qualidade do projeto.
...
### 2) Consolidacao do portfolio academico
Consolidacao do portfolio academico ajuda a transformar criterio visual e estrutural em implementacao reproduzivel.
...
### 3) Planejamento de continuidade na formacao
Planejamento de continuidade na formacao conecta a aula a cenarios reais de desenvolvimento e manutencao.
...
## Resumo final
Neste encontro, voce estudou **Fechamento da disciplina, autoavaliacao e consolidacao de portfolio** com foco em escolha tecnologica, customizacao consciente e entrega profissional.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Fechamento da disciplina, autoavaliacao e consolidacao de portfolio" ajuda a resolver?
