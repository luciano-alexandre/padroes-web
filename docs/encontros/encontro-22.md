# Encontro 22 - SEO on-page, metadados e estrutura documental

**Unidade:** Unidade 1  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Pagina otimizada

## Explicacao geral do encontro
Este encontro trabalha **SEO on-page, metadados e estrutura documental** na consolidacao de HTML semantico, acessibilidade e arquitetura da informacao.

![Imagem de apoio 1](https://upload.wikimedia.org/wikipedia/commons/6/61/HTML5_logo_and_wordmark.svg)

## Conceitos essenciais
- Uso de titulos, descricoes e metadados
- Estrutura documental para indexacao e manutencao
- Boas praticas de nomes de arquivos e links

## Explicacao detalhada dos conceitos essenciais
### 1) Uso de titulos, descricoes e metadados
Uso de titulos, descricoes e metadados orienta a tomada de decisao tecnica e melhora a qualidade do projeto.

#### Exemplo aplicado

```text
title: Laboratorio de Interfaces
description: Conteudos, projetos e orientacoes da disciplina
```

### 2) Estrutura documental para indexacao e manutencao
Estrutura documental para indexacao e manutencao ajuda a transformar criterio visual e estrutural em implementacao reproduzivel.
...
### 3) Boas praticas de nomes de arquivos e links
Boas praticas de nomes de arquivos e links conecta a aula a cenarios reais de desenvolvimento e manutencao.
...
## Resumo final
Neste encontro, voce estudou **SEO on-page, metadados e estrutura documental** com foco em estrutura semantica, qualidade tecnica e documentacao adequada.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "SEO on-page, metadados e estrutura documental" ajuda a resolver?
